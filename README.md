...
1.
Importe o ficheiro bd.sql para o seu servidor MySQL.

2.
Configure as credenciais de acesso em ficha1/config/ligacao.php.

3.
Coloque os ficheiros num servidor web com suporte para PHP (ex: XAMPP, WAMP).

4.
Aceda ao index.php para iniciar a aplicação.
